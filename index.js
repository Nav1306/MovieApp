...
// fucntion to create movie cards
...
const createMovieCard = (movies) => {
  for (let movie of movies) {
    ...
    //creating card title
    const titlEle = createElement("p");
    titlEle.classList.add("title");
    titlEle.innerText = movie.name;
    cardDetails.appendChild(titlEle);
    ...
    ratings.classList.add("star-ratings");
...
const debounceInput = debounce(handleSearch,1000);
